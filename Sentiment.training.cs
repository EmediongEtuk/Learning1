...
namespace Learning1
{
    ...
    {
        public const string RetrainFilePath =  @"D:\ML\Learning1\yelp_labelled.txt";
        ...
        public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext)
        {
            ...
            var pipeline = mlContext.Transforms.Text.FeaturizeText(inputColumnName:@"col0",outputColumnName:@"col0")      
                                    ...
                                    .Append(mlContext.MulticlassClassification.Trainers.OneVersusAll(binaryEstimator:mlContext.BinaryClassification.Trainers.FastTree(new FastTreeBinaryTrainer.Options(){NumberOfLeaves=13,MinimumExampleCountPerLeaf=11,NumberOfTrees=7,MaximumBinCountPerFeature=283,FeatureFraction=0.913372253220812,LearningRate=0.999999776672986,LabelColumnName=@"col1",FeatureColumnName=@"Features",DiskTranspose=false}),labelColumnName: @"col1"))      
